...
@Entity
@Table(name = "sense")
public class SenseEntity implements com.pwr.bzapps.plwordnetmobile.service.database.entity.Entity, Serializable, Comparable<SenseEntity>{
    @Id
    private Integer id;
    ...
    @Override
    public int compareTo(SenseEntity entity) {
        int comparison = 0;
